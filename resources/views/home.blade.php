			...
			<ul class="nav flex-nowrap align-items-center ms-sm-3 list-unstyled">
				...
				<li class="nav-item ms-2 dropdown">
					<a class="nav-link btn icon-md p-0" href="#" id="profileDropdown" role="button" data-bs-auto-close="outside" data-bs-display="static" data-bs-toggle="dropdown" aria-expanded="false">
						<img class="avatar-img rounded-2" src="{{asset('import/assets/images/avatar/07.jpg')}}" alt="">
					</a>
...
{{--                                                    <button type="button" class="btn btn-danger-soft me-2"><i class="bi bi-camera-video-fill pe-1"></i> Live video</button>--}}
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<!-- Card img -->
						<img class="card-img" src="{{asset('import/assets/images/post/3by2/01.jpg')}}" alt="Post">
						<!-- Feed react START -->
						...
						<div class="d-flex mb-3">
							<!-- Avatar -->
							<div class="avatar avatar-xs me-2">
								<a href="#!"> <img class="avatar-img rounded-circle" src="{{asset('import/assets/images/avatar/12.jpg')}}" alt=""> </a>
							</div>
							<!-- Comment box  -->
...
{{--							<div>--}}
{{--								<!-- Card START -->--}}
{{--								<div class="card card-overlay-bottom border-0 position-relative h-150px" style="background-image:url({{asset('import/assets/images/post/1by1/02.jpg')}}); background-position: center left; background-size: cover;">--}}
